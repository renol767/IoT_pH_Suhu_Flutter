...
const completeColor = Colors.deepOrangeAccent;
const inProgressColor = Colors.orangeAccent;
        ...
        body: Timeline.tileBuilder(
          ...
          builder: TimelineTileBuilder.connected(
            ...
            itemExtentBuilder: (_, __) =>
                MediaQuery.of(context).size.width / _processes.length + 80,
                          ...
                          (_processIndex == index)
                              ? Container(
                                  ...
                                  child: Text(
                                    _desc[index],
                                    style: TextStyle(
                                        fontSize: 12, color: getColor(index)),
                                  ),
                                )
                              : Text("")
                        ],
